    ...
    <DashboardLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
                        <h1 className="text-4xl font-bold tracking-tight text-black dark:text-white">F1 DRIVERS</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Complete Formula 1 driver roster and team information</p>
          </div>
